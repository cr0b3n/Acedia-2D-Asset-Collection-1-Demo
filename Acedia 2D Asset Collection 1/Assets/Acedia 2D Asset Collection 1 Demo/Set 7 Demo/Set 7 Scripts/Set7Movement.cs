...
public class Set7Movement : MonoBehaviour, ICharActivatable {
    ...
    public CharacterSet CharSet { get => CharacterSet.Set7; }
    ...
    private void Dash() {
        ...
        if (!hasDashEffect) {
            ...
            DemoController.instance.ShowEffect(new Vector3(transform.position.x, transform.position.y + 1.5f), new Vector3(input.direction * -1f, 1f, 1f), EffectType.Dash);
            hasDashEffect = true;
        }
